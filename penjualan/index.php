...
if ($kode) {
    ...
    if ($dataBrg && mysqli_num_rows($dataBrg) > 0) {
        $selectBrg = mysqli_fetch_array($dataBrg);
    } else {
        echo "<script>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-warning p-3">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" name="tglJual" class="form-control" id="tglNota"
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-10 input-group">
                                    <input type="text" name="barcode" id="barcode"
                                        value="<?= @$_GET['barcode'] ? $_GET['barcode'] : '' ?>" class="form-control"
                                        placeholder="masukan barcode barang">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="icon-barcode"> <i
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="hidden" value="<?= @$_GET['barcode'] ? $selectBrg['barcode'] : '' ?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a
                                        href="?barcode=<?= $detail['barcode'] ?>&idjual=<?= $detail['no_jual'] ?>&qty=<?= $detail['qty'] ?>&tgl=<?= $detail['tgl_jual'] ?>&msg=deleted"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 py-2 px-3">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="kembalian" class="form-control-sm text-right" id="kembalian"
                                    readonly>
                            </div>
                        </div>
                    </div>
