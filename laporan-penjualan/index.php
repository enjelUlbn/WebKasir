            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-primary float-right" data-toggle="modal"
                        data-target="#mdlPeriodeJual"><i class="fas fa-print"> Cetak</i></button>
                </div>
                        ...
                        foreach($penjualan as $jual){?>
                            <tr>
                                ...
                                <td class=text-center><a
                                        href="detail-penjualan.php?id=<?= $jual['no_jual'] ?>&tgl=<?= in_date($jual['tgl_jual']) ?>"
                                        class="btn btn-sm btn-info" title="rincian barang">Detail</a>
                                </td>
                            </tr>
